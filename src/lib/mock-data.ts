...
export const MOCK_POSTS: Post[] = [
  ...
  {
    id: 'p2', user_id: 'u2', title: 'MacBook Air M3 深度使用两周感受', content: '从 Intel 换到 M3，性能飞跃太明显了。日常办公、写代码、剪视频都很流畅，续航一整天不用担心。屏幕素质顶级，键盘手感也改善了很多。', images: [placeholderImg('macbook', 0, 400, 300), placeholderImg('macbook', 1, 400, 450)], tags: ['数码', '电脑'], product_name: 'MacBook Air M3', price: '¥8999', rating: 5, like_count: 512, comment_count: 89, status: 'active', created_at: '2025-06-14T08:00:00Z', user: { nickname: MOCK_USERS[1].nickname, avatar_url: MOCK_USERS[1].avatar_url },
  },
  {
  ...
  {
    id: 'p5', user_id: 'u5', title: '跑步三个月，终于找到合适的跑鞋', content: 'Nike Pegasus 41 真的是全能跑鞋，缓震舒适、回弹有力、透气性好。日常 5-10km 训练完全够用，新手入门首选！', images: [placeholderImg('shoes', 0, 400, 400), placeholderImg('shoes', 1, 400, 300), placeholderImg('shoes', 2, 400, 500)], tags: ['运动', '跑鞋'], product_name: 'Nike Pegasus 41', price: '¥899', rating: 5, like_count: 245, comment_count: 38, status: 'active', created_at: '2025-06-11T09:15:00Z', user: { nickname: MOCK_USERS[4].nickname, avatar_url: MOCK_USERS[4].avatar_url },
  },
  {
  ...
  {
    id: 'p7', user_id: 'u4', title: '学生党护肤全套推荐', content: '分享我用了两年的平价护肤流程：珂润洁面→悦木之源菌菇水→CeraVe乳液→安耐晒小金瓶。简单四步，皮肤状态稳定不翻车。', images: [placeholderImg('skincare', 0, 400, 500), placeholderImg('skincare', 1, 400, 400), placeholderImg('skincare', 2, 400, 300), placeholderImg('skincare', 3, 400, 350), placeholderImg('skincare', 4, 400, 400)], tags: ['美妆', '护肤'], product_name: '平价护肤套装', price: '¥380', rating: 5, like_count: 1203, comment_count: 234, status: 'active', created_at: '2025-06-09T15:30:00Z', user: { nickname: MOCK_USERS[3].nickname, avatar_url: MOCK_USERS[3].avatar_url },
  },
  {
    id: 'p8', user_id: 'u2', title: 'Switch OLED 值不值得升级？', content: '从初代 Switch 换到 OLED 版，屏幕提升太明显了，色彩鲜艳、边框更窄。底座新增网线接口，TV 模式更稳定。如果经常掌机模式，强烈推荐升级！', images: [placeholderImg('switch', 0, 400, 300), placeholderImg('switch', 1, 400, 400)], tags: ['数码', '游戏'], product_name: 'Nintendo Switch OLED', price: '¥2299', rating: 4, like_count: 367, comment_count: 52, status: 'active', created_at: '2025-06-08T13:00:00Z', user: { nickname: MOCK_USERS[1].nickname, avatar_url: MOCK_USERS[1].avatar_url },
  },
]
