...
export const MOCK_POSTS: Post[] = [
  ...
  {
    id: 'p2', user_id: 'u2', title: 'MacBook Air M3 深度使用两周感受', content: '从 Intel 换到 M3，性能飞跃太明显了。日常办公、写代码、剪视频都很流畅，续航一整天不用担心。屏幕素质顶级，键盘手感也改善了很多。', images: [placeholderImg('macbook', 0, 400, 300), placeholderImg('macbook', 1, 400, 450)], tags: ['数码', '电脑'], product_name: 'MacBook Air M3', price: '¥8999', rating: 5, like_count: 512, comment_count: 89, favorite_count: 53, status: POST_STATUS.ACTIVE, created_at: '2025-06-14T08:00:00Z', updated_at: '2025-06-14T08:00:00Z', user: { nickname: MOCK_USERS[1].nickname, avatar_url: MOCK_USERS[1].avatar_url },
  },
  {
    id: 'p3', user_id: 'u3', title: '宜家这款收纳柜绝了，小户型必备', content: 'KALLAX 系列收纳柜，简约百搭，组装简单。放书、放杂物、当隔断都行。白色款和我的房间风格完美搭配，价格也很友好。', images: [placeholderImg('cabinet', 0, 400, 500), placeholderImg('cabinet', 1, 400, 300), placeholderImg('cabinet', 2, 400, 400), placeholderImg('cabinet', 3, 400, 350)], tags: ['家居', '收纳'], product_name: 'IKEA KALLAX 收纳柜', price: '¥399', rating: 4, like_count: 186, comment_count: 23, favorite_count: 13, status: POST_STATUS.ACTIVE, created_at: '2025-06-13T14:20:00Z', updated_at: '2025-06-13T14:20:00Z', user: { nickname: MOCK_USERS[2].nickname, avatar_url: MOCK_USERS[2].avatar_url },
  },
  {
    id: 'p4', user_id: 'u4', title: '平价替代！这支口红完全不输大牌', content: 'colorkey 唇釉 #R702，颜色是超温柔的豆沙玫瑰色，质地丝滑不拔干，持久度也不错。日常通勤涂超好看，价格才几十块！', images: [placeholderImg('lipstick', 0, 400, 500), placeholderImg('lipstick', 1, 400, 300)], tags: ['美妆', '口红'], product_name: 'Colorkey 唇釉 R702', price: '¥59', rating: 4, like_count: 892, comment_count: 156, favorite_count: 93, status: POST_STATUS.ACTIVE, created_at: '2025-06-12T16:45:00Z', updated_at: '2025-06-12T16:45:00Z', user: { nickname: MOCK_USERS[3].nickname, avatar_url: MOCK_USERS[3].avatar_url },
  },
  {
    id: 'p5', user_id: 'u5', title: '跑步三个月，终于找到合适的跑鞋', content: 'Nike Pegasus 41 真的是全能跑鞋，缓震舒适、回弹有力、透气性好。日常 5-10km 训练完全够用，新手入门首选！', images: [placeholderImg('shoes', 0, 400, 400), placeholderImg('shoes', 1, 400, 300), placeholderImg('shoes', 2, 400, 500)], tags: ['运动', '跑鞋'], product_name: 'Nike Pegasus 41', price: '¥899', rating: 5, like_count: 245, comment_count: 38, favorite_count: 22, status: POST_STATUS.ACTIVE, created_at: '2025-06-11T09:15:00Z', updated_at: '2025-06-11T09:15:00Z', user: { nickname: MOCK_USERS[4].nickname, avatar_url: MOCK_USERS[4].avatar_url },
  },
  {
    id: 'p6', user_id: 'u1', title: '戴森吹风机值不值得买？', content: '用了半年来说，真的值！吹干速度快一倍，头发顺滑不毛躁，而且很轻不累手。虽然贵但每天用，算下来性价比很高。', images: [placeholderImg('dryer', 0, 400, 450), placeholderImg('dryer', 1, 400, 300)], tags: ['家居', '个护'], product_name: 'Dyson Supersonic', price: '¥2990', rating: 4, like_count: 421, comment_count: 67, favorite_count: 40, status: POST_STATUS.ACTIVE, created_at: '2025-06-10T11:00:00Z', updated_at: '2025-06-10T11:00:00Z', user: { nickname: MOCK_USERS[0].nickname, avatar_url: MOCK_USERS[0].avatar_url },
  },
  {
    id: 'p7', user_id: 'u4', title: '学生党护肤全套推荐', content: '分享我用了两年的平价护肤流程：珂润洁面→悦木之源菌菇水→CeraVe乳液→安耐晒小金瓶。简单四步，皮肤状态稳定不翻车。', images: [placeholderImg('skincare', 0, 400, 500), placeholderImg('skincare', 1, 400, 400), placeholderImg('skincare', 2, 400, 300), placeholderImg('skincare', 3, 400, 350), placeholderImg('skincare', 4, 400, 400)], tags: ['美妆', '护肤'], product_name: '平价护肤套装', price: '¥380', rating: 5, like_count: 1203, comment_count: 234, favorite_count: 140, status: POST_STATUS.ACTIVE, created_at: '2025-06-09T15:30:00Z', updated_at: '2025-06-09T15:30:00Z', user: { nickname: MOCK_USERS[3].nickname, avatar_url: MOCK_USERS[3].avatar_url },
  },
  {
    id: 'p8', user_id: 'u2', title: 'Switch OLED 值不值得升级？', content: '从初代 Switch 换到 OLED 版，屏幕提升太明显了，色彩鲜艳、边框更窄。底座新增网线接口，TV 模式更稳定。如果经常掌机模式，强烈推荐升级！', images: [placeholderImg('switch', 0, 400, 300), placeholderImg('switch', 1, 400, 400)], tags: ['数码', '游戏'], product_name: 'Nintendo Switch OLED', price: '¥2299', rating: 4, like_count: 367, comment_count: 52, favorite_count: 31, status: POST_STATUS.ACTIVE, created_at: '2025-06-08T13:00:00Z', updated_at: '2025-06-08T13:00:00Z', user: { nickname: MOCK_USERS[1].nickname, avatar_url: MOCK_USERS[1].avatar_url },
  },
]
